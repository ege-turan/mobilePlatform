...
//                   ActivePlan = &AllPlans[CurrentPlanIndex];
...
//         MotorCmdEvent.EventType = ActivePlan->Steps[StepCounter].PrimitiveCmd;
//         MotorCmdEvent.EventParam = 0; // Add parameters if needed
...
//         {
//           // Optionally post the PostEvent for this step if not ES_NO_EVENT
//           if (ActivePlan->Steps[StepCounter].PostEvent != ES_NO_EVENT)
//           {
//             ES_Event_t PostEvent = { ActivePlan->Steps[StepCounter].PostEvent, 0 };
//             ES_PostAll(PostEvent);  // or wherever it should go
//           }
          
//           // Increment step counter
//           StepCounter++;
          
//           if (ActivePlan->Steps[StepCounter].PostEvent == ES_PLAN_DONE)
//           {
//             //   // All steps done, post step complete to this SM to transition
//             //   ES_Event_t StepCompleteEvent = { ES_PLAN_DONE, 0 };
//             //   PostDriverFromToSM(StepCompleteEvent);
//           }
//           else
//           {
//               // Send the next step command to motor service
//               ES_Event_t NextMotorCmd = { ActivePlan->Steps[StepCounter].PrimitiveCmd, 0 };
//               PostDCMotorService(NextMotorCmd);
//           }
          
//           // Consume this event so it’s not processed further
//           ReturnEvent.EventType = ES_NO_EVENT;
//         }
